...
public class ClientControllerStandard implements ClientInterface {
    ...
    public ClientControllerStandard(String ipServer, Integer portServer, PurchaseInterface gui) {
